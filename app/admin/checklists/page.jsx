...
export default async function Page() {
  ...
  const initialChecklists = records.map((record) => ({
    ...
    equipmentTypes: Array.isArray(record.equipmentTypes) ? record.equipmentTypes : [],
    equipmentIds: Array.isArray(record.equipmentIds) ? record.equipmentIds.map((id) => id.toString()) : [],
    allowedProfiles: Array.isArray(record.allowedProfiles) ? record.allowedProfiles : [],
    mandatoryProfiles: Array.isArray(record.mandatoryProfiles) ? record.mandatoryProfiles : [],
    tags: record.tags || [],
